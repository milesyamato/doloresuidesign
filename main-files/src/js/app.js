!(function (TynApp) {
  ...
  TynApp.Appbar = function(){
    ...
    document.getElementById('tynBotSend').onclick = function() {
        var messageContent = document.getElementById('tynBotInput').innerText;
        socket.emit('send_message', {content: messageContent});
        // Clear the input field after sending the message
        document.getElementById('tynBotInput').innerText = '';
};
    socket.on('new_message', function(data) {
        // Code to handle incoming messages
        // You can append this data to your chat UI
  ...
  function updateGreeting() {
    ...
    const userName = "Ira"; // You can change the name as needed
    ...
    const greeting = `${partOfDay} ${userName}, today is ${date} and it is ${time} in ${location}`;
...
// Initial call to display greeting immediately
updateGreeting();
